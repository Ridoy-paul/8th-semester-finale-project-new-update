...
@section('title')Error 255 @endsection
@section('description')Error 255  @endsection
@section('keywords')Error 255 @endsection
@section('content')
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center py-5">
                            ...
                            <h2 class="error__content--title my-5">Error 255!</h2>
