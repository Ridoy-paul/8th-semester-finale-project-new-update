...
@section('title')Error 405 @endsection
@section('description')Error 405  @endsection
@section('keywords')Error 405 @endsection
@section('content')
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center py-5">
                            ...
                            <h2 class="error__content--title my-5">Error 405!</h2>
